...
| Ridge Regression (baseline) | Teste (p14, 615) | 20,2px | 16,8px | 8,2px | 100% |
...
```python
tracking_engine: str = "mock"         # desenvolvimento (padrão)
tracking_engine: str = "irisgazenet"  # produção — MobileNetV2 + SVR
```
